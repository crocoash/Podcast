...
class LikedMomentsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        //print(LikedMomentsManager.shared().getLikedMomentsFromUserDefault())
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        //print("Count \(LikedMomentsManager.shared().getLikedMomentsFromUserDefault().count)")
    }
...
extension LikedMomentsViewController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        delegate?.likedMomentViewController(self, didSelect: LikedMomentsManager.shared().likedMoments[indexPath.row])
    }
