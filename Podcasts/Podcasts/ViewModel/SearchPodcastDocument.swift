...
//        
//        let isSearchedPredicate = NSPredicate(format: "isSearched = true")
//        fetchRequest.predicate = NSCompoundPredicate(andPredicateWithSubpredicates: [isSearchedPredicate])
//        
